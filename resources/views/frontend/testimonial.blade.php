...
<div id="contact-page" class="container">
    <div class="bg">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="title text-center">Testimonial <strong></strong></h2>
                <br />
            </div>
        </div>
        <div class="row">
            <div class="col-sm-8">
                <div class="contact-form">
                    ...
                    @endif
                    <br />
                    {!! Form::open(array('route'=>'testimonial.post','method'=>'post','class'=>'contact-form row')) !!}
                        ...
                        <div class="form-group col-md-12">
                            <input type="text" name="perusahaan" class="form-control" required="required" placeholder="Perusahaan">
                        </div>
                        <div class="form-group col-md-12">
                            <textarea name="isi" id="message" required="required" class="form-control" rows="8" placeholder="Your Message Here"></textarea>
                        </div>
                        <div class="form-group col-md-12">
